//! redeem_sol: burn exact shares and receive native SOL (lamports).
...
pub fn handler(ctx: Context<RedeemSol>, shares: u64, min_assets_out: u64) -> Result<()> {
